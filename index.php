      ...
      <div class="row justify-content-center h-100 align-items-center contenedorLogin">
        <div class="col-12 formLogin">
          <form action="iniciar_sesion.php" method="POST" class="p-4">
            ...
            <div class="mb-3">
              <label for="usuario" class="form-label text-white"><i class="fa-solid fa-user text-white"></i>
                Usuario</label>
              <input type="text" name="Usuario" class="form-control" id="usuario" placeholder="Nombre de Usuario"
                required>
            </div>
            <div class="mb-3">
              <label for="clave" class="form-label text-white"><i class="fa-solid fa-unlock text-white"></i>
                Clave</label>
